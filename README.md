...
<table>
  <tr valign="top">
    <td align="center" width="65%">
      <b>Desktop</b>
      <br/><br/>
      <img src="./frontend/public/desktop_screen.png" width="100%" alt="App Screenshot Desktop" />
    </td>
    <td align="center" width="32%">
      <b>Mobile</b>
      <br/><br/>
      <img src="./frontend/public/mobile_screen.png" width="100%" alt="App Screenshot Mobile" />
    </td>
  </tr>
</table>
...
The project includes automated unit tests to ensure the business logic of the shopping cart works correctly.

- **Cart Logic Validation:** Tests cover subtotal calculations, item adding/removal, and quantity updates.
- **Navigation:** Verified that cart routing and page transitions work as expected.
